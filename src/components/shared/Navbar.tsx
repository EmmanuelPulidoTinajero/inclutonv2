...
import {Menu, X, Instagram, Linkedin, Facebook, Music2, Link} from 'lucide-react';
...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <span
                className="text-2xl font-bold bg-gradient-to-r from-[#FF6B2B] to-[#2B7BFF] bg-clip-text text-transparent">
              INCLUTON
            </span>
                        </Link>
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            //TODO aca se elimino iun size="lg"
                            <Button
