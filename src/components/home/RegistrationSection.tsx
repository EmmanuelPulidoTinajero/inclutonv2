      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Únete a INCLUTON 2025 y sé parte del cambio hacia una teclsxología más inclusiva
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Únete a la revolución de la teclsxología inclusiva y ayuda a construir un futuro digital para todos
            </p>
            //todo aca se elimino un size="lg"
            <Button
