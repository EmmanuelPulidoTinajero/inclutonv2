            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Empresas comprometidas con un futuro teclsxológico más inclusivo
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 mb-20 max-w-[1600px] mx-auto">
                    {sponsors.map((sponsor, index) => (
                        ...
                        >
                            ...
                            />
                            <div
                                className="absolute inset-0 bg-black/5 group-hover:bg-black/0 transition-colors duration-300"/>
                        </motion.a>
                    ))}
                </div>
