...
const pillars = [
  {
    ...
    description: "La teclsxología es para todos",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Un hackathon único que une teclsxología e inclusión para crear soluciones que transforman vidas.
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                {pillar.title === "Inclusión Total" ? "La teclsxología es para todas las personas" :
