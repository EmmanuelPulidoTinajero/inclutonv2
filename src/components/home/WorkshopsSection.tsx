...
import {SpeakerRegistrationForm} from '../forms/speaker/SpeakerRegistrationForm';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Talleres prácticos para los Equipos de la hackaton, diseñados para potenciar tus habilidades
                            y llevar tu solución al siguiente nivel
                        </p>
                    </motion.div>
                        ...
                        {workshops.map((workshop, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {React.cloneElement(workshop.icon as any, {className: "w-8 h-8"})}
                                    </div>
                                </div>
                                <h3
                                ...
                                <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                                    {workshop.title === "Diseño UX/UI accesible" ? "Aprende a crear interfaces que todas las personas puedan usar" :
                                        workshop.title === "Programación inclusiva" ? "Desarrolla aplicaciones accesibles desde el código para cada persona usuaria" :
                                            workshop.title === "Teclsxologías asistivas" ? "Explora herramientas que facilitan la accesibilidad universal" :
