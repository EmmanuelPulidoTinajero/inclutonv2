...
const prizeCategories = [
  ...
  {
    title: "Desarrollo Téclsxico",
    color: "#2B7BFF", // Azul para desarrollo
    icon: <Code className="w-6 h-6" />,
    description: "Excelencia en implementación y soluciones téclsxicas"
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20 max-w-[1600px] mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Equipos diversos y multidisciplinarios colaborarán desarrollando soluciones teclsxológicas
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-4">Cumbre de Inclusión Teclsxológica</h3>
            <p className="text-gray-600 mb-6">
              Un espacio de aprendizaje y networking donde expertos internacionales
              compartirán conocimientos sobre teclsxología inclusiva.
            </p>
            <div className="mb-6">
            ...
            >
              Asiste a la Cumbre Teclsxológica
            </Button>
          </motion.div>
        </div>
