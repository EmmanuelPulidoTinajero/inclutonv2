...
export function SoloParticipantForm() {
  ...
  return (
      <FormWrapper
          ...
          description="Encuentra el equipo perfecto para crear teclsxología inclusiva"
          error={error}
      >
        <FormProvider {...methods}>
          <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
                ...
                type="textarea"
                placeholder="Cuéntanos sobre tu experiencia en teclsxología, accesibilidad o proyectos similares..."
                required
            />
